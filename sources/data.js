const restaurants = [
    ...
    },
    {
        id: 4,
        nom: "Grenache",
        description: "Passez une soirée avec nous sur le thème de la cuisine française, méditerranéenne, diversifiée ou traditionnelle et découvrez ses divers aspects. Vous trouvez aussi chez nous des spécialités méditerranéennes. Profitez des journées ensoleillées dans notre terrasse décontractée. La cuisine française vous gâtera avec son exclusive variété de délices culinaires. Nos excellents plats du terroir sont particulièrement prisés pour leur fraîcheur et leur saveur particulière. Goûtez par exemple à nos plats de poisson prisés. Goûtez aussi volontiers un bon verre de vin, un cocktail fruité ou un verre de bière rafraîchissant lorsque vous viendrez nous voir. Nous vous proposons le wifi sans frais. Vous restez ainsi informé pendant votre déplacement. Un espace fumeur est spécialement aménagé pour les amateurs de tabac. Réservez une table chez nous aujourd’hui encore et venez découvrir notre cuisine exquise dans un cadre élégant. Contactez nous tél. au +33980828592. Le paiement par carte VISA, MasterCard, tickets repas, chèque et carte de débit est accepté. Vous avez toujours la possibilité de payer en espèces. Les festivités privées sont tout à fait possibles pour nous – contactez-nous pour en savoir plus. Vous fêtez un mariage ? Nous serions ravis de participer à cet événement particulier dans votre vie. Le dimanche et le lundi sont nos jours de repos. Tous les autres jours, nous serions heureux de vous servir.",
        note: 3,
